...
import { defaultHttp } from '../../utils/axios';
  ...
  return (
    <Fragment>
      <div className="flex gap-6 justify-center	items-center">
        <img width="30" height="20" src="/icon.png" alt="logo"></img>
        <h1 className="text-xl font-bold leading-tight tracking-tight text-blue-900 md:text-2xl text-left  tracking-wide">
          Handy Hire
        </h1>
      </div>
      <Form
