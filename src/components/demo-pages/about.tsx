            ...
            <div className="my-12 grid grid-cols-1 gap-6 sm:grid-cols-2">
              <div className="group relative rounded-xl border border-slate-200">
                ...
                <div className="relative overflow-hidden rounded-xl p-6">
                  ...
                  <h2 className="mt-4 font-display text-base text-slate-900">
                    <a
                      href="https://github.com/arifszn/Handy-Hire"
                      target="_blank"
                      rel="noreferrer"
              ...
              <div className="group relative rounded-xl border border-slate-200">
                ...
                <div className="relative overflow-hidden rounded-xl p-6">
                  ...
                  <h2 className="mt-4 font-display text-base text-slate-900">
                    <a
                      href="https://github.com/arifszn/Handy-Hire/issues"
                      target="_blank"
                      rel="noreferrer"
                      className="hover:text-primary"
                    >
              ...
              <div className="group relative rounded-xl border border-slate-200">
                ...
                <div className="relative overflow-hidden rounded-xl p-6">
                  ...
                  <h2 className="mt-4 font-display text-base text-slate-900">
                    <a
                      href="https://github.com/arifszn/Handy-Hire/discussions/categories/ideas"
                      target="_blank"
                      rel="noreferrer"
                      className="hover:text-primary"
                    >
              ...
              <div className="group relative rounded-xl border border-slate-200">
                ...
                <div className="relative overflow-hidden rounded-xl p-6">
                  ...
                  <h2 className="mt-4 font-display text-base text-slate-900">
                    <a
                      href="https://github.com/arifszn/Handy-Hire/blob/main/CONTRIBUTING.md"
                      target="_blank"
                      rel="noreferrer"
                      className="hover:text-primary"
                    >
